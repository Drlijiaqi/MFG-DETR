...
## Synergistic Dual-Stage Attention Fusion (SDSA-Fusion)  Start
...
class SDSA_Fusion(nn.Module):
    def __init__(self, dim, heads):
        super(SDSA_Fusion, self).__init__()
...
######################################## ## Synergistic Dual-Stage Attention Fusion (SDSA-Fusion) end ########################################